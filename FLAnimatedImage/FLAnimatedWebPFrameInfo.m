...
- (NSString *)description {
    return [NSString stringWithFormat:@"disposeToBackground: %@, blendPrevFrame: %@, alpha: %@",
            [@(_disposeToBackground) boolValue] ? @"YES" : @"NO"
            , [@(_blendWithPreviousFrame) boolValue] ? @"YES" : @"NO"
            , [@(_hasAlpha) boolValue] ? @"YES" : @"NO"];
}
